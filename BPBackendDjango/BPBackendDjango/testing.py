...
class UserTestCase(TestCase):
    ...
    def check_if_exists(self):
        ...
        self.assertTrue(User.objects.filter(first_name="Erik", last_name="Prescher", username="DeadlyFarts", trainer=1, email_address="prescher-erik@web.de", password="Password1234").exists())
    ...
    def check_if_user_gets_deleted_when_trainer_gets_deleted(self):
        ...
        self.assertFalse(User.objects.filter(first_name="Erik", last_name="Prescher", username="DeadlyFarts", trainer=1, email_address="prescher-erik@web.de", password="Password1234").exists())