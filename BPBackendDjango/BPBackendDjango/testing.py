...
class FriendViewTestCase(TestCase):
    ...
    def test_friends(self):
        ...
        request = ViewSupport.setup_request({'Session-Token': token2}, {'id': self.user1.id})
        ...
        response = AddFriendView.post(AddFriendView, request)
        request = ViewSupport.setup_request({'Session-Token': token3}, {'id': self.user1.id})
        ...
        request = ViewSupport.setup_request({'Session-Token': token1}, {'id': self.user2.id})
