...
class ProfileTestCase(TestCase):
    ...
    def test_done_exercises_of_month(self):
        ...
        dex = DoneExercises.objects.create(exercise=exip, user=user, points=100, date=int(datetime.datetime(year=2022, month=2, day=12, hour=21, minute=53, second=47).timestamp()))
        #valid
        result = [{
            ...
            "id": exip.exercise.id,
            "date": int(datetime.datetime(year=2022, month=2, day=5, hour=12).timestamp()),
            "points": None,
            "done": True
        }]
        request = ViewSupport.setup_request({'Session-Token': self.token2}, {
