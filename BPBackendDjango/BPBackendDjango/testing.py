...
class FriendViewTestCase(TestCase):
    ...
    def test_friends(self):
        ...
        request = ViewSupport.setup_request({'Session-Token': token2}, {'username': self.user1.id})
        ...
        response = AddFriendView.post(AddFriendView, request)
        request = ViewSupport.setup_request({'Session-Token': token3}, {'username': self.user1.id})
        ...
        request = ViewSupport.setup_request({'Session-Token': token1}, {'username': self.user2.id})
